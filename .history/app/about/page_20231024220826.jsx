...
export default function About() {
    ...
    return(
        <div className='text-main-color text-center flex grid-cols-1 justify-content-center mt-20 h-[calc(100vh-74px)]'>
            ...
            <div className='mt-3 w-9/12 mx-auto'>
                ...
                <Signature className="fill-main-color mx-auto pl-20 sm:w-full md:w-6/12"/>
            </div>
        </div>
    )
}