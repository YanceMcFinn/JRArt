      ...
      <div className="grid grid-cols-3 gap-8 place-items-center mx-20">
        {paintings.map(art=>{
          ...
          <div className='text-center relative max-w-xs overflow-hidden bg-cover bg-no-repeat'>
            ...
            <div
        class=" text-center content-center absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-indigo-700 bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-50">
          TEST
        </div>
