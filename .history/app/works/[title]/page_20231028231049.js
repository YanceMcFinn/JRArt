...
export default function Work({params}){
  ...
  return(
    <div className="flex md:flex-row sm:flex-col px-2 mt-20 text-main-color">
      <div className="md:basis-1/2 sm:basis-full">
        <Image src={imgSrc}
          className='mx-auto h-[calc(100vh-74px)] pb-10 w-auto'
          width={500}
          height={500}
          alt={piece.title} />
      </div>
      <div className="md:basis-1/2 h-[calc(100vh-74px)] px-4"> 
