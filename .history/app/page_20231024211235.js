      ...
      <div className="grid grid-cols-3 gap-8 place-items-center mx-20">
        {paintings.map(art=>{
          ...
          <div className='text-center'>
            ...
            <div
        class="z-10 absolute bottom-0 left-0 right-0 top-0 w-full overflow-hidden bg-green-700 bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-70"></div>
          </div>)
