    ...
    return(
        <div className='text-main-color text-center justify-content-center mt-20'>
            <div className='title text-center text-3xl'>Contact Me</div>
                <form className='w-2/3 flex justify-content-center'>
                    <div className='flex mb-2'>
                        <label for="email" className='pr-3 title text-xl'>Your email</label>
                        <input type="email" className='rounded px-2 bg-white/25 border border-main-color text-main-color'id="email" placeholder="Your email address" required/>
                    </div>
                    <div className='flex'>
