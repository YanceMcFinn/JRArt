            ...
            <div className='title text-center text-3xl'>Contact Me</div>
                <form className='w-6/12 mx-auto'>
                    ...
                    <div className='mb-2 flex justify-end'>
                        ...
                        <input type="text" id="subject" className='rounded w-full px-2 bg-white/25 border border-main-color text-main-color placeholder-main-color/50 focus:border-main-color focus:border-2 focus:outline-none focus:ring-0' placeholder="What are you asking about?" required/>
                    </div>
