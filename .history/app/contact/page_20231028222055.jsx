            ...
            <div className='title text-center text-3xl'>Contact Me</div>
                <form className='w-2/3 mx-auto justify-content-center'>
                    <div className='flex mb-2'>
                        ...
                        <input type="email" className='rounded px-2 bg-white/25 border border-main-color text-main-color focus:border-main-color focus:border-2 focus:outline-none focus:ring-0'id="email" placeholder="Your email address" required/>
                    </div>
                    <div className='flex'>
