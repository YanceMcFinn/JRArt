    ...
    return(
        <div className='text-main-color text-center justify-content-center mt-20'>
            <div className='title text-center text-3xl'>Contact Me</div>
              ...
              <label for="message" className='pr-3 title text-xl' >Your message</label><br/>
              <textarea id="message" rows="6" placeholder="Leave a comment..." className='rounded px-2 bg-white/25 border border-main-color text-main-color placeholder-main-color/50 focus:border-main-color focus:border-2 focus:outline-none focus:ring-0'></textarea>
          </div>
