    ...
    return(
        <div className='text-main-color text-center justify-content-center mt-20'>
            <div className='title text-center text-4xl mb-3'>Contact Me</div>
                <form className='md:w-9/12 mx-auto justify-center'>
                    <div className='w-9/12 mb-2 flex justify-center mx-auto'>
                        <label for="email" className='pr-3 title text-l md:text-xl'>Your email address</label>
